...
const OUT_DIR = path.resolve('orderbhojan/ios-hotfix-proof');
const REPORT_PATH = path.resolve('orderbhojan/ios-hotfix-proof-report.json');
...
const report = {
  ...
  commit,
  base: BASE,
  bundleBefore: 'assets/index-DoFE5dzf.js',
  bundleAfter: null,
