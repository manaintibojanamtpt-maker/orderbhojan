...
const OUT_DIR = path.resolve('orderbhojan/post-deploy-location-fix-proof');
const REPORT_PATH = path.resolve('orderbhojan/post-deploy-location-fix-report.json');
...
const report = {
  ...
  commit: '7158a2f',
  base: BASE,
  bundleBefore: 'assets/index-UZ7_2QNQ.js',
  bundleAfter: 'assets/index-DoFE5dzf.js',
  steps: {},
  consoleErrors: [],
  consoleWarnings: [],
  network: [],
