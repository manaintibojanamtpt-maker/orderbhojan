/** Pricing switch certification metadata (M8 PR-13). Pure domain — no SDK imports. */

export const PRICING_CERTIFICATION_MODULE_VERSION =
  '0.1.0-pricing-projection-switch-certification' as const;
export const PRICING_CERTIFICATION_MODULE_NAME =
  'pricing-projection-read-switch-certification' as const;

export const PRICING_CERTIFICATION_BLOCK_REASONS = {
  FLAG_DISABLED: 'FF_PRICING_PROJECTION_CERTIFICATION_ENABLED is off',
  ...
  PRODUCTION_ALREADY_APPROVED:
    'Manual production approval already granted — certification only',
...
export const PRICING_CERTIFICATION_GO_NO_GO = {
