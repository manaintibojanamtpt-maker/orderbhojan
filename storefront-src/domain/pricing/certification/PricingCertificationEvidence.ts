/** Pricing certification evidence types (M8 PR-13). Pure domain — no SDK imports. */

export type PricingOperationalHealthLevel = 'GREEN' | 'AMBER' | 'RED';
...
export interface OperationalValidationEvidence {
  readonly health: PricingOperationalHealthLevel;
...
export interface RolloutMetricsEvidence {
  ...
  readonly rolloutHealthy: boolean;
}
...
export interface ProjectionSoakEvidence {
...
export interface PricingCertificationEvidenceBundle {
  ...
  readonly soak: ProjectionSoakEvidence;
