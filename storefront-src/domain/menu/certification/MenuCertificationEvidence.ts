/** Menu certification evidence types (M7 PR-13). Pure domain — no SDK imports. */

export type MenuOperationalHealthLevel = 'GREEN' | 'AMBER' | 'RED';
...
export interface OperationalValidationEvidence {
  readonly health: MenuOperationalHealthLevel;
...
export interface MenuCertificationEvidenceBundle {
