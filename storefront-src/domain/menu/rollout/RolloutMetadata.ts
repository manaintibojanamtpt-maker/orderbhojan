/** Menu rollout metadata (M7 PR-12). Pure domain — no SDK imports. */

export const ROLLOUT_MODULE_VERSION = '0.1.0-menu-projection-rollout' as const;
export const ROLLOUT_MODULE_NAME = 'menu-projection-rollout' as const;

export const ROLLOUT_BLOCK_REASONS = {
  FLAG_DISABLED: 'FF_MENU_PROJECTION_ROLLOUT_ENABLED is off',
