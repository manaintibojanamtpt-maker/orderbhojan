...
export interface MenuParityStatisticsSummary extends MenuParityStatistics {
...
export const EMPTY_MENU_PARITY_STATISTICS: MenuParityStatistics = {
  totalCompared: 0,
  matched: 0,
  mismatched: 0,
...
export function accumulateMenuParityStatistics(
  current: MenuParityStatistics,
  outcome: MenuParityOutcome,
  durationMs = 0
): MenuParityStatistics {
  const base: MenuParityStatistics = {
    ...current,
...
export function summarizeMenuParityStatistics(
  statistics: MenuParityStatistics
