/** Rollout policy rules (M6 PR-12). Pure domain — no SDK imports. */
...
export function evaluateRolloutPromotion(
  ...
  if (!context.health.parityReady) {
    blockers.push(ROLLOUT_BLOCK_REASONS.PARITY_NOT_READY);
  }
