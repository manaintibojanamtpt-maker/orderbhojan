...
// Disable verbose workbox dev logs in production
(self as any).__WB_DISABLE_DEV_LOGS = true;

// Cache versioning to force PWA refresh
const SW_VERSION = 'v47-firestore-bypass';
...
// Never let the SW touch Firestore, Firebase Auth, Google APIs, or token endpoints
registerRoute(
  ({ url }) => {
