...
import {
  KITCHEN_HERO_EYEBROW,
  KITCHEN_HERO_ROTATION_MS,
  KITCHEN_HERO_SCENES,
} from '@/features/experience/data/kitchenHeroScenes';
import { resolveHeroFoodPhoto } from '@/features/experience/data/food-photo-manifest';
  ...
  const slides = useMemo(
    () =>
      KITCHEN_HERO_SCENES.map((scene) => {
        const photo = resolveHeroFoodPhoto(scene.assetId);
        return {
          id: scene.id,
          headline: scene.headline ?? scene.subline,
